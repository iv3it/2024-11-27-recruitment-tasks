...
export default function MenuEmptyState() {
  return (
    <section className="w-full bg-[#F9FAFB] rounded-lg flex flex-col px-4 py-6 border border-[#EAECF0]">
      ...
      <button className='shadow-[0_1px_2px_0px_rgba(16,24,40,0.05)] self-center py-[0.625rem] px-4 flex bg-[var(--purpleMedium)] border border-[var(--purpleMedium)] rounded-lg'>
