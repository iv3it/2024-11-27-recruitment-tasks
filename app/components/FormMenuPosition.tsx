...
export default function FormMenuPosition() {
  ...
  return (
    <section className="flex gap-4 border border-[var(--greyLight)] rounded-lg mt-8 bg-white py-5 px-6">
      <form onSubmit={handleSubmit(onSubmit)} className="w-full">
        <div className="mb-2 flex flex-col">
          <label className="font-medium text-sm text-[var(--greyDark) mb-[6px]">Nazwa</label>
        ...
        <div className="mb-2 flex flex-col">
          <label className="font-medium text-sm text-[var(--greyDark) mb-[6px]">Link</label>
          <div className="flex items-center relative">
            <svg className="absolute left-[14px] mr-2" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <input {...register("url")} type="text" className="w-full shadow-[0_1px_2px_0px_rgba(16,24,40,0.05)] border border-[var(--greyLight)] rounded-lg py-2 pl-[42px] pr-[14px] text-[var(--greyLight2)] placeholder:text-[var(--greyLight2)]" placeholder="Wklej lub wyszukaj"/>
          </div>
        </div>

        <div className="mt-5 flex gap-2">
          <button className="shadow-[0_1px_2px_0px_rgba(16,24,40,0.05)] rounded-lg border border-[var(--greyLight)] py-[10px] px-[14px] font-semibold text-sm text-[var(--greyDark)]">Anuluj</button>
          <input type="submit" className="shadow-[0_1px_2px_0px_rgba(16,24,40,0.05)] rounded-lg border border-[var(--purpleLight)] py-[10px] px-[14px] font-semibold text-sm text-[var(--purpleDark)]" value="Dodaj"/>
        </div>
      </form>
